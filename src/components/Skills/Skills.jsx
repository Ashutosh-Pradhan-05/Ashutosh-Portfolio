...
const Skills = () => (
  ...
  >
    ...
    <div className="text-center mb-8">
      <h2 className="text-gray-300 text-3xl sm:text-4xl font-bold">
        TECH &nbsp;STACKS
      </h2>
      <motion.div
        animate={{
    ...
    <div className="flex flex-wrap gap-1 lg:gap-5 py-10 justify-between">
      {SkillsInfo.map((category) => (
        <div
          key={category.title}
          className="bg-radial from-[#050414] from-50% to-[#2c076c] backdrop-blur-md px-6 sm:px-10 py-8 sm:py-6 mb-10 w-full sm:w-[48%] rounded-2xl border border-white 
          shadow-[0_0_20px_1px_rgba(130,69,236,0.3)]"
        >
          <h3 className="text-2xl sm:text-3xl font-semibold text-gray-300 mb-1 text-center">
            {category.title}
          </h3>
          {/* //Horizontal line */}
          <div className="w-full h-1 bg-gradient-to-r from-[#ff7f50] from-1% via-[#8245ec] via-50% to-[#ff7f50] to-99% mx-auto mb-10"></div>
