      ...
      <div className="relative min-h-screen">
        ...
        {experiences.map((experience, index) => (
          ...
          >
            ...
            {/* Content Section */}
            <div
              className={`w-full sm:max-w-md p-4 sm:p-8 rounded-2xl border border-white bg-gray-900 backdrop-blur-md shadow-[0_0_20px_1px_rgba(130,69,236,0.7)] ${index % 2 === 0 ? "sm:ml-0" : "sm:mr-0"
