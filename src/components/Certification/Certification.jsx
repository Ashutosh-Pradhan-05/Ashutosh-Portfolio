        ...
        >
            ...
            <div className="grid gap-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                {certifications.map((cert) => (
                    <div
                        key={cert.id}
                        className="relative overflow-visible border border-white/10 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 rounded-2xl shadow-xl transition-transform transform hover:-translate-y-2 duration-300"
                    >
                            ...
                            <div className="mt-6">
                                ...
                                <div className="text-gray-300 text-sm space-y-2 text-left">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span>Issued: <span className="text-gray-300 font-bold">{cert.issueddate}</span></span>
                                    </div>

                                    <div className="flex items-center gap-2">
                                        <RiPassValidFill size={20} className="text-purple-400" />
                                        <span>Score: <span className="text-gray-300 font-bold">{cert.score}</span></span>
                                    </div>

                                    <div className="flex items-center gap-2">
                                        <FaIdCard size={20} className="text-purple-400" />
                                        <span>Credential ID: <span className="text-gray-300 font-bold">{cert.cid}</span></span>
                                    </div>

                                    <div className="flex items-center gap-2">
                                        <FaRegCalendarDays size={20} className="text-purple-400" />
                                        <span>Valid: <span className="text-gray-300 font-bold">{cert.valid}</span></span>
                                    </div>
                                </div>
