  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-16">
        <h2 className="text-4xl font-bold text-gray-300">CERTIFICATIONS</h2>
        <motion.div
          animate={{
          ...
          >
            ...
            <div className="pt-16 sm:pt-20 lg:pt-24 px-5 pb-6">
              ...
              <div className="mt-6">
                ...
                <div className="w-full h-1 bg-gradient-to-r from-[#ff7f50] from-1% via-[#8245ec] via-50% to-[#ff7f50] to-99% mb-4" />
